...
#define NLEDS 32 //Number of LEDS in the string. 32 LEDs in this strip.
#define NBYTES 128 //Number of LEDs times 4 (3 color bytes and a flag byte)
...
#define NCOLORS 128 //Total number of RGB colors = 128 colors per LED
#define NCOLORBYTES 512 //Total number of cycled colors including flags.
...
void setup(void){
    ...
    DCOCTL = CALDCO_1MHZ;  //Slow = DCO 16MHZ
    BCSCTL1 |= CALBC1_1MHZ;        //slow = SMCLK 16MHZ
